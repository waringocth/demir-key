...
const FAQS = [
  ...
  },
  {
    ...
    a: "Başta Esenyurt ve Bahçeşehir olmak üzere bu ilçelerin tüm mahallelerinde aktif servis sağlıyoruz. Esenyurt'ta Akıncılar, Fatih, Cumhuriyet, Pınar, Mehterçeşme mahallelerine; Bahçeşehir için ise tüm kısımlara hizmet sağlıyoruz. Bunların dışındaki İstanbul bölgeleri için de iletişime geçmenizi öneririz.",
  },
];
